...
setAlarm.addEventListener('click', () => {
    let now = new Date();
    if (dateInput.value != null && hourInput.value != null && minuteInput.value != null && dateInput.value < 32 && dateInput.value > 0 && hourInput.value > 0 && hourInput.value < 13 && minuteInput.value > 0 && minuteInput.value < 60) {
